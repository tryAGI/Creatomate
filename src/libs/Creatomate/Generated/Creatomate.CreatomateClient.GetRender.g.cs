...
namespace Creatomate
{
    public partial class CreatomateClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Creatomate.Render> GetRenderAsync(
            global::System.Guid renderId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Creatomate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Creatomate.AutoSDKHttpResponse<global::Creatomate.Render>> GetRenderAsResponseAsync(
            global::System.Guid renderId,
            global::Creatomate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                else
                {
                    await global::Creatomate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Creatomate.ErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Creatomate.ErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Creatomate.Render.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Creatomate.AutoSDKHttpResponse<global::Creatomate.Render>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Creatomate.Render.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
