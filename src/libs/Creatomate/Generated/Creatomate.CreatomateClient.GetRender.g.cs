                    ...
                    await global::Creatomate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Creatomate.Render.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Creatomate.Render.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
