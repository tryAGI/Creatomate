...
{
    /// <inheritdoc />
    public sealed class CreateRenderRequestOutputFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Creatomate.CreateRenderRequestOutputFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Creatomate.CreateRenderRequestOutputFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
