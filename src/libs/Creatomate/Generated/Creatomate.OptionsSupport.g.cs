...
namespace Creatomate
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Creatomate.AutoSDKRetryOptions Retry { get; set; } = new global::Creatomate.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Creatomate.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Creatomate.IAutoSDKHook>();
        ...
        public global::Creatomate.AutoSDKClientOptions AddHook(
            global::Creatomate.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Creatomate.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Creatomate.AutoSDKClientOptions UseAuthorizationProvider(
            global::Creatomate.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Creatomate.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Creatomate.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Creatomate.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Creatomate.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Creatomate.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Creatomate.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Creatomate.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Creatomate.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Creatomate.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Creatomate.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Creatomate.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Creatomate.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Creatomate.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Creatomate.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Creatomate.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Creatomate.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Creatomate.AutoSDKClientOptions clientOptions,
            global::Creatomate.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Creatomate.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Creatomate.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Creatomate.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Creatomate.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Creatomate.IAutoSDKHook, global::Creatomate.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Creatomate.AutoSDKHookContext context)
        {
